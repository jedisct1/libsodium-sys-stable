...
pub const SODIUM_VERSION_STRING: &[u8; 7] = b"1.0.22\0";
pub const SODIUM_LIBRARY_VERSION_MAJOR: u32 = 26;
pub const SODIUM_LIBRARY_VERSION_MINOR: u32 = 4;
...
pub const crypto_hash_sha3256_BYTES: u32 = 32;
pub const crypto_hash_sha3512_BYTES: u32 = 64;
...
pub const crypto_kem_xwing_PUBLICKEYBYTES: u32 = 1216;
pub const crypto_kem_xwing_SECRETKEYBYTES: u32 = 32;
pub const crypto_kem_xwing_CIPHERTEXTBYTES: u32 = 1120;
pub const crypto_kem_xwing_SHAREDSECRETBYTES: u32 = 32;
pub const crypto_kem_xwing_SEEDBYTES: u32 = 32;
pub const crypto_kem_PUBLICKEYBYTES: u32 = 1216;
pub const crypto_kem_SECRETKEYBYTES: u32 = 32;
pub const crypto_kem_CIPHERTEXTBYTES: u32 = 1120;
pub const crypto_kem_SHAREDSECRETBYTES: u32 = 32;
pub const crypto_kem_SEEDBYTES: u32 = 32;
pub const crypto_kem_PRIMITIVE: &[u8; 6] = b"xwing\0";
pub const crypto_kem_mlkem768_PUBLICKEYBYTES: u32 = 1184;
pub const crypto_kem_mlkem768_SECRETKEYBYTES: u32 = 2400;
pub const crypto_kem_mlkem768_CIPHERTEXTBYTES: u32 = 1088;
pub const crypto_kem_mlkem768_SHAREDSECRETBYTES: u32 = 32;
pub const crypto_kem_mlkem768_SEEDBYTES: u32 = 64;
...
unsafe extern "C" {
    pub fn crypto_hash_sha3256_statebytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_hash_sha3256_bytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_hash_sha3256(
        out: *mut libc::c_uchar,
        in_: *const libc::c_uchar,
        inlen: libc::c_ulonglong,
    ) -> libc::c_int;
...
unsafe extern "C" {
    pub fn crypto_hash_sha3256_init(state: *mut crypto_hash_sha3256_state) -> libc::c_int;
}
unsafe extern "C" {
    pub fn crypto_hash_sha3256_update(
...
unsafe extern "C" {
    pub fn crypto_hash_sha3512_statebytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_hash_sha3512_bytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_hash_sha3512(
        out: *mut libc::c_uchar,
        in_: *const libc::c_uchar,
        inlen: libc::c_ulonglong,
    ) -> libc::c_int;
...
unsafe extern "C" {
    pub fn crypto_hash_sha3512_init(state: *mut crypto_hash_sha3512_state) -> libc::c_int;
}
unsafe extern "C" {
    pub fn crypto_hash_sha3512_update(
...
unsafe extern "C" {
    pub fn crypto_kem_xwing_publickeybytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_xwing_secretkeybytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_xwing_ciphertextbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_xwing_sharedsecretbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_xwing_seedbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_xwing_seed_keypair(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
        seed: *const libc::c_uchar,
    ) -> libc::c_int;
...
unsafe extern "C" {
    pub fn crypto_kem_xwing_keypair(pk: *mut libc::c_uchar, sk: *mut libc::c_uchar) -> libc::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn crypto_kem_publickeybytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_secretkeybytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_ciphertextbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_sharedsecretbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_seedbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_primitive() -> *const libc::c_char;
}
unsafe extern "C" {
    pub fn crypto_kem_seed_keypair(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
        seed: *const libc::c_uchar,
    ) -> libc::c_int;
...
unsafe extern "C" {
    pub fn crypto_kem_keypair(pk: *mut libc::c_uchar, sk: *mut libc::c_uchar) -> libc::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_publickeybytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_secretkeybytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_ciphertextbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_sharedsecretbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_seedbytes() -> usize;
}
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_seed_keypair(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
        seed: *const libc::c_uchar,
    ) -> libc::c_int;
...
unsafe extern "C" {
    pub fn crypto_kem_mlkem768_keypair(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
    ) -> libc::c_int;
}
